...
Pool.prototype.status = promisify(function(callback) {
  var self = this;
  var status = {};
...
Pool.prototype.initialize = promisify(function(callback) {
  var self = this;
...
Pool.prototype.reserve = promisify(function(callback) {
  var self = this;
  var conn = null;
...
Pool.prototype.release = promisify(function(conn, callback) {
  var self = this;
...
Pool.prototype.purge = promisify(function(callback) {
  var self = this;

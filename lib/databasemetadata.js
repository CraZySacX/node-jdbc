 ...
 */
DatabaseMetaData.prototype.getSchemas = promisify(function(catalog, schemaPattern, callback) {
 ...
 */
DatabaseMetaData.prototype.getTables = promisify(function(catalog, schemaPattern, tableNamePattern, types, callback) {
  var validParams = (
    (_.isNull(catalog) || _.isUndefined(catalog) || _.isString(catalog)) &&
    (_.isNull(schemaPattern) || _.isUndefined(schemaPattern) || _.isString(schemaPattern)) &&
 ...
 */
DatabaseMetaData.prototype.allProceduresAreCallable = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.allTablesAreSelectable = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.autoCommitFailureClosesAllResultSets = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.dataDefinitionCausesTransactionCommit = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.dataDefinitionIgnoredInTransactions = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.deletesAreDetected = promisify(function(type, callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.doesMaxRowSizeIncludeBlobs = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.generatedKeyAlwaysReturned = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getAttributes = promisify(function(catalog, schemaPattern, typeNamePattern, attributeNamePattern, callback) {
  var validParams = (
    (_.isNull(catalog) || _.isUndefined(catalog) || _.isString(catalog)) &&
    (_.isNull(schemaPattern) || _.isUndefined(schemaPattern) || _.isString(schemaPattern)) &&
 ...
 */
DatabaseMetaData.prototype.getBestRowIdentifier = promisify(function(catalog, schema, table, scope, nullable, callback) {
  var validParams = (
    (_.isNull(catalog) || _.isUndefined(catalog) || _.isString(catalog)) &&
 ...
 */
DatabaseMetaData.prototype.getCatalogs = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getCatalogSeparator = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getCatalogTerm = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getClientInfoProperties = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getColumnPrivileges = promisify(function(catalog, schema, table, columnNamePattern, callback) {
  var validParams = (
    (_.isNull(catalog) || _.isUndefined(catalog) || _.isString(catalog)) &&
    (_.isNull(schema) || _.isUndefined(schema) || _.isString(schema)) &&
    _.isString(table) &&
 ...
 * @returns {ResultSet} Via callback: each row is a column description
 */
DatabaseMetaData.prototype.getColumns = promisify(function(catalog, schemaPattern, tableNamePattern, columnNamePattern, callback) {
  var validParams = (
    (_.isNull(catalog) || _.isUndefined(catalog) || _.isString(catalog)) &&
    (_.isNull(schemaPattern) || _.isUndefined(schemaPattern) || _.isString(schemaPattern)) &&
    (_.isNull(tableNamePattern) || _.isUndefined(tableNamePattern) || _.isString(tableNamePattern)) &&
 ...
 */
DatabaseMetaData.prototype.getConnection = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getCrossReference = promisify(function(parentCatalog, parentSchema, parentTable, foreignCatalog, foreignSchema, foreignTable, callback) {
  var validParams = (
 ...
 */
DatabaseMetaData.prototype.getDatabaseMajorVersion = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getDatabaseMinorVersion = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getDatabaseProductName = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getDatabaseProductVersion = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getDefaultTransactionIsolation = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getDriverMajorVersion = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getDriverMinorVersion = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getDriverName = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getDriverVersion = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getExportedKeys = promisify(function(catalog, schema, table, callback) {
  var validParams = (
    (_.isNull(catalog) || _.isUndefined(catalog) || _.isString(catalog)) &&
    (_.isNull(schema) || _.isUndefined(schema) || _.isString(schema)) &&
    _.isString(table)
 ...
 */
DatabaseMetaData.prototype.getExtraNameCharacters = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getFunctionColumns = promisify(function(catalog, schemaPattern, functionNamePattern, columnNamePattern, callback) {
  var validParams = (
    (_.isNull(catalog) || _.isUndefined(catalog) || _.isString(catalog)) &&
    (_.isNull(schemaPattern) || _.isUndefined(schemaPattern) || _.isString(schemaPattern)) &&
 ...
 */
DatabaseMetaData.prototype.getFunctions = promisify(function(catalog, schemaPattern, functionNamePattern, callback) {
  var validParams = (
    (_.isNull(catalog) || _.isUndefined(catalog) || _.isString(catalog)) &&
    (_.isNull(schemaPattern) || _.isUndefined(schemaPattern) || _.isString(schemaPattern)) &&
    (_.isNull(functionNamePattern) || _.isUndefined(functionNamePattern) || _.isString(functionNamePattern))
 ...
 */
DatabaseMetaData.prototype.getIdentifierQuoteString = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getImportedKeys = promisify(function(catalog, schema, table, callback) {
  var validParams = (
    (_.isNull(catalog) || _.isUndefined(catalog) || _.isString(catalog)) &&
    (_.isNull(schema) || _.isUndefined(schema) || _.isString(schema)) &&
    _.isString(table)
 ...
 */
DatabaseMetaData.prototype.getIndexInfo = promisify(function(catalog, schema, table, unique, approximate, callback) {
  var validParams = (
    (_.isNull(catalog) || _.isUndefined(catalog) || _.isString(catalog)) &&
    (_.isNull(schema) || _.isUndefined(schema) || _.isString(schema)) &&
    _.isString(table) &&
 ...
 */
DatabaseMetaData.prototype.getJDBCMajorVersion = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getJDBCMinorVersion = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getMaxBinaryLiteralLength = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getMaxCatalogNameLength = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getMaxCharLiteralLength = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getMaxColumnNameLength = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getMaxColumnsInGroupBy = promisify(function(callback) {
 ...
 * @returns {Number} Via callback: the maximum number of columns allowed; a result of zero means that there is no limit or the limit is not known
 */
DatabaseMetaData.prototype.getMaxColumnsInIndex = promisify(function(callback) {
 ...
 * @returns {Number} Via callback: the maximum number of columns allowed; a result of zero means that there is no limit or the limit is not known
 */
DatabaseMetaData.prototype.getMaxColumnsInOrderBy = promisify(function(callback) {
 ...
 * @returns {Number} Via callback: the maximum number of columns allowed; a result of zero means that there is no limit or the limit is not known
 */
DatabaseMetaData.prototype.getMaxColumnsInSelect = promisify(function(callback) {
 ...
 * @returns {Number} Via callback: the maximum number of columns allowed; a result of zero means that there is no limit or the limit is not known
 */
DatabaseMetaData.prototype.getMaxColumnsInTable = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getMaxConnections = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getMaxCursorNameLength = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getMaxIndexLength = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getMaxProcedureNameLength = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getMaxRowSize = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getMaxSchemaNameLength = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getMaxStatementLength = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getMaxStatements = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getMaxTableNameLength = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getMaxTablesInSelect = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getMaxUserNameLength = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getNumericFunctions = promisify(function(callback) {
 ...
 * @returns {ResultSet} Via callback: each row is a primary key column description
 */
DatabaseMetaData.prototype.getPrimaryKeys = promisify(function(catalog, schema, table, callback) {
  var validParams = (
    (_.isNull(catalog) || _.isUndefined(catalog) || _.isString(catalog)) &&
    (_.isNull(schema) || _.isUndefined(schema) || _.isString(schema)) &&
    _.isString(table)
 ...
 */
DatabaseMetaData.prototype.getProcedureColumns = promisify(function(catalog, schemaPattern, procedureNamePattern, columnNamePattern, callback) {
  var validParams = (
    (_.isNull(catalog) || _.isUndefined(catalog) || _.isString(catalog)) &&
    (_.isNull(schemaPattern) || _.isUndefined(schemaPattern) || _.isString(schemaPattern)) &&
 ...
 */
DatabaseMetaData.prototype.getProcedures = promisify(function(catalog, schemaPattern, procedureNamePattern, callback) {
  var validParams = (
    (_.isNull(catalog) || _.isUndefined(catalog) || _.isString(catalog)) &&
    (_.isNull(schemaPattern) || _.isUndefined(schemaPattern) || _.isString(schemaPattern)) &&
    (_.isNull(procedureNamePattern) || _.isUndefined(procedureNamePattern) || _.isString(procedureNamePattern))
 ...
 */
DatabaseMetaData.prototype.getProcedureTerm = promisify(function(callback) {
 ...
 * @returns {ResultSet} Via callback: each row is a column description
 */
DatabaseMetaData.prototype.getPseudoColumns = promisify(function(catalog, schemaPattern, tableNamePattern, columnNamePattern, callback) {
  var validParams = (
    (_.isNull(catalog) || _.isUndefined(catalog) || _.isString(catalog)) &&
    (_.isNull(schemaPattern) || _.isUndefined(schemaPattern) || _.isString(schemaPattern)) &&
    (_.isNull(tableNamePattern) || _.isUndefined(tableNamePattern) || _.isString(tableNamePattern)) &&
 ...
 */
DatabaseMetaData.prototype.getResultSetHoldability = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getRowIdLifetime = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getSchemaTerm = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getSearchStringEscape = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getSQLKeywords = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getSQLStateType = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getStringFunctions = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getSuperTables = promisify(function(catalog, schemaPattern, tableNamePattern, callback) {
  var validParams = (
    (_.isNull(catalog) || _.isUndefined(catalog) || _.isString(catalog)) &&
    (_.isNull(schemaPattern) || _.isUndefined(schemaPattern) || _.isString(schemaPattern)) &&
    (_.isNull(tableNamePattern) || _.isUndefined(tableNamePattern) || _.isString(tableNamePattern))
 ...
 */
DatabaseMetaData.prototype.getSuperTypes = promisify(function(catalog, schemaPattern, typeNamePattern, callback) {
  var validParams = (
    (_.isNull(catalog) || _.isUndefined(catalog) || _.isString(catalog)) &&
    (_.isNull(schemaPattern) || _.isUndefined(schemaPattern) || _.isString(schemaPattern)) &&
    (_.isNull(typeNamePattern) || _.isUndefined(typeNamePattern) || _.isString(typeNamePattern))
 ...
 */
DatabaseMetaData.prototype.getSystemFunctions = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getTablePrivileges = promisify(function(catalog, schemaPattern, tableNamePattern, callback) {
  var validParams = (
    (_.isNull(catalog) || _.isUndefined(catalog) || _.isString(catalog)) &&
    (_.isNull(schemaPattern) || _.isUndefined(schemaPattern) || _.isString(schemaPattern)) &&
    (_.isNull(tableNamePattern) || _.isUndefined(tableNamePattern) || _.isString(tableNamePattern))
 ...
 */
DatabaseMetaData.prototype.getTableTypes = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getTimeDateFunctions = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getTypeInfo = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getUDTs = promisify(function(catalog, schemaPattern, typeNamePattern, types, callback) {
  var validParams = (
    (_.isNull(catalog) || _.isUndefined(catalog) || _.isString(catalog)) &&
    (_.isNull(schemaPattern) || _.isUndefined(schemaPattern) || _.isString(schemaPattern)) &&
    (_.isNull(typeNamePattern) || _.isUndefined(typeNamePattern) || _.isString(typeNamePattern)) &&
 ...
 */
DatabaseMetaData.prototype.getURL = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getUserName = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.getVersionColumns = promisify(function(catalog, schema, table, callback) {
  var validParams = (
    (_.isNull(catalog) || _.isUndefined(catalog) || _.isString(catalog)) &&
    (_.isNull(schema) || _.isUndefined(schema) || _.isString(schema)) &&
    _.isString(table)
 ...
 */
DatabaseMetaData.prototype.insertsAreDetected = promisify(function(type, callback) {
  var validParams = _.isInteger(type);
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.isCatalogAtStart = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.isReadOnly = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.locatorsUpdateCopy = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.nullPlusNonNullIsNull = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.nullsAreSortedAtEnd = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.nullsAreSortedAtStart = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.nullsAreSortedHigh = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.nullsAreSortedLow = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.othersDeletesAreVisible = promisify(function(type, callback) {
  var validParams = _.isInteger(type);
 ...
 */
DatabaseMetaData.prototype.othersInsertsAreVisible = promisify(function(type, callback) {
  var validParams = _.isInteger(type);
 ...
 */
DatabaseMetaData.prototype.othersUpdatesAreVisible = promisify(function(type, callback) {
  var validParams = _.isInteger(type);
 ...
 */
DatabaseMetaData.prototype.ownDeletesAreVisible = promisify(function(type, callback) {
  var validParams = _.isInteger(type);
 ...
 */
DatabaseMetaData.prototype.ownInsertsAreVisible = promisify(function(type, callback) {
  var validParams = _.isInteger(type);
 ...
 */
DatabaseMetaData.prototype.ownUpdatesAreVisible = promisify(function(type, callback) {
  var validParams = _.isInteger(type);
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.storesLowerCaseIdentifiers = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.storesLowerCaseQuotedIdentifiers = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.storesMixedCaseIdentifiers = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.storesMixedCaseQuotedIdentifiers = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.storesUpperCaseIdentifiers = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.storesUpperCaseQuotedIdentifiers = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsAlterTableWithAddColumn = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsAlterTableWithDropColumn = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsANSI92EntryLevelSQL = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsANSI92FullSQL = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsANSI92IntermediateSQL = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.supportsBatchUpdates = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsCatalogsInDataManipulation = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsCatalogsInIndexDefinitions = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsCatalogsInPrivilegeDefinitions = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsCatalogsInProcedureCalls = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsCatalogsInTableDefinitions = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsColumnAliasing = promisify(function(callback) {
 ...
 * @returns {Boolean}  Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsConvert = promisify(function(fromType, toType, callback) {
  var validParams = (
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsCoreSQLGrammar = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsCorrelatedSubqueries = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsDataDefinitionAndDataManipulationTransactions = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsDataManipulationTransactionsOnly = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsDifferentTableCorrelationNames = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsExpressionsInOrderBy = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsExtendedSQLGrammar = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsFullOuterJoins = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsGetGeneratedKeys = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsGroupBy = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsGroupByBeyondSelect = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsGroupByUnrelated = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsIntegrityEnhancementFacility = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsLikeEscapeClause = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsLimitedOuterJoins = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsMinimumSQLGrammar = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsMixedCaseIdentifiers = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsMixedCaseQuotedIdentifiers = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsMultipleOpenResults = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsMultipleResultSets = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsMultipleTransactions = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsNamedParameters = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsNonNullableColumns = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsOpenCursorsAcrossCommit = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsOpenCursorsAcrossRollback = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsOpenStatementsAcrossCommit = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsOpenStatementsAcrossRollback = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsOrderByUnrelated = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsOuterJoins = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsPositionedDelete = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsPositionedUpdate = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsResultSetConcurrency = promisify(function(type, concurrency, callback) {
  var validParams = (
    _.isInteger(type) &&
 ...
 * @returns {Boolean} Via callback: true if so, false otherwise
 */
DatabaseMetaData.prototype.supportsResultSetHoldability = promisify(function(holdability, callback) {
 ...
 * @returns {Boolean} Via callback: true if so, false otherwise
 */
DatabaseMetaData.prototype.supportsResultSetType = promisify(function(type, callback) {
  var validParams = _.isInteger(type);
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsSavepoints = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsSchemasInDataManipulation = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsSchemasInIndexDefinitions = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsSchemasInPrivilegeDefinitions = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsSchemasInProcedureCalls = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsSchemasInTableDefinitions = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsSelectForUpdate = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsStatementPooling = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsStoredFunctionsUsingCallSyntax = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsStoredProcedures = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsSubqueriesInComparisons = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsSubqueriesInExists = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsSubqueriesInIns = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsSubqueriesInQuantifieds = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsTableCorrelationNames = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so, false otherwise
 */
DatabaseMetaData.prototype.supportsTransactionIsolationLevel = promisify(function(level, callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsTransactions = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsUnion = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.supportsUnionAll = promisify(function(callback) {
 ...
 */
DatabaseMetaData.prototype.updatesAreDetected = promisify(function(type, callback) {
  var validParams = _.isInteger(type);
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.usesLocalFilePerTable = promisify(function(callback) {
 ...
 * @returns {Boolean} Via callback: true if so; false otherwise
 */
DatabaseMetaData.prototype.usesLocalFiles = promisify(function(callback) {

...
Connection.prototype.abort = promisify(function(executor, callback) {
  return callback(new Error("NOT IMPLEMENTED"));
});

Connection.prototype.clearWarnings = promisify(function(callback) {
...
Connection.prototype.close = promisify(function(callback) {
  var self = this;
...
Connection.prototype.commit = promisify(function(callback) {
...
Connection.prototype.createArrayOf = promisify(function(typename, objarr, callback) {
  return callback(new Error("NOT IMPLEMENTED"));
});

Connection.prototype.createBlob = promisify(function(callback) {
  return callback(new Error("NOT IMPLEMENTED"));
});

Connection.prototype.createClob = promisify(function(callback) {
  return callback(new Error("NOT IMPLEMENTED"));
});

Connection.prototype.createNClob = promisify(function(callback) {
  return callback(new Error("NOT IMPLEMENTED"));
});

Connection.prototype.createSQLXML = promisify(function(callback) {
  return callback(new Error("NOT IMPLEMENTED"));
});

Connection.prototype.createStatement = promisify(function(arg1, arg2, arg3, callback) {
...
Connection.prototype.createStruct = promisify(function(typename, attrarr, callback) {
  return callback(new Error("NOT IMPLEMENTED"));
});

Connection.prototype.getAutoCommit = promisify(function(callback) {
...
Connection.prototype.getCatalog = promisify(function(callback) {
...
Connection.prototype.getClientInfo = promisify(function(name, callback) {
  // Get arguments as an array
  var args = Array.prototype.slice.call(arguments);
...
Connection.prototype.getHoldability = promisify(function(callback) {
...
Connection.prototype.getMetaData = promisify(function(callback) {
...
Connection.prototype.getNetworkTimeout = promisify(function(callback) {
...
Connection.prototype.getSchema = promisify(function(callback) {
...
Connection.prototype.getTransactionIsolation = promisify(function(callback) {
  var self = this;
...
Connection.prototype.getTypeMap = promisify(function(callback) {
...
Connection.prototype.getWarnings = promisify(function(callback) {
...
Connection.prototype.isClosed = promisify(function(callback) {
...
Connection.prototype.isReadOnly = promisify(function(callback) {
...
Connection.prototype.isValid = promisify(function(timeout, callback) {
...
Connection.prototype.nativeSQL = promisify(function(sql, callback) {
  return callback(new Error("NOT IMPLEMENTED"));
});

Connection.prototype.prepareCall = promisify(function(sql, rstype, rsconcurrency, rsholdability, callback) {
  // Get arguments as an array
  var args = Array.prototype.slice.call(arguments);
 ...
 */
Connection.prototype.prepareStatement = promisify(function(sql, arg1, arg2, arg3, callback) {
  // Get arguments as an array
  var args = Array.prototype.slice.call(arguments);
...
Connection.prototype.releaseSavepoint = promisify(function(savepoint, callback) {
...
Connection.prototype.rollback = promisify(function(savepoint, callback) {
  // Get arguments as an array
  var args = Array.prototype.slice.call(arguments);
...
Connection.prototype.setAutoCommit = promisify(function(autocommit, callback) {
...
Connection.prototype.setCatalog = promisify(function(catalog, callback) {
...
Connection.prototype.setClientInfo = promisify(function(props, name, value, callback) {
  // Get arguments as an array
  var args = Array.prototype.slice.call(arguments);
...
Connection.prototype.setHoldability = promisify(function(holdability, callback) {
...
Connection.prototype.setNetworkTimeout = promisify(function(executor, ms, callback) {
  return callback(new Error('NOT IMPLEMENTED'));
});

Connection.prototype.setReadOnly = promisify(function(readonly, callback) {
...
Connection.prototype.setSavepoint = promisify(function(name, callback) {
  // Get arguments as an array
  var args = Array.prototype.slice.call(arguments);
...
Connection.prototype.setSchema = promisify(function(schema, callback) {
...
Connection.prototype.setTransactionIsolation = promisify(function(txniso, callback) {
...
Connection.prototype.setTypeMap = promisify(function(map, callback) {
  return callback(new Error('NOT IMPLEMENTED'));
});

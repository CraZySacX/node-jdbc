...
module.exports = {
  getConnection: promisify(function(url, propsoruser, password, callback) {
  ...
  getLoginTimeout: promisify(function(callback) {
  ...
  registerDriver: promisify(function(driver, callback) {
  ...
  setLoginTimeout: promisify(function(seconds, callback) {

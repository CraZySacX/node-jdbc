...
ResultSet.prototype.toObjArray = promisify(function (callback) {
...
ResultSet.prototype.toObject = promisify(function (callback) {
...
ResultSet.prototype.toObjectIter = promisify(function (callback) {
  var self = this;
...
ResultSet.prototype.close = promisify(function (callback) {
...
ResultSet.prototype.getMetaData = promisify(function (callback) {

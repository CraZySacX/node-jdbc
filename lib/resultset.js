            ...
            next: function () {
              ...
              _.each(_.range(1, colcount + 1), function (i) {
                ...
                if (type === 'Date' || type === 'Time' || type === 'Timestamp') {
                  ...
                  // If the column is an integer or Boolean or Double and is null, set result to null and continue
                  if (['Int', 'Boolean', 'Double'].includes(type) && _.isNull(self._rs.getObjectSync(cmd.label))) {
